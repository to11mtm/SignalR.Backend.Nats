...
internal sealed class NatsChannels
{
    ...
    /// </summary>
    /// <remarks>
    /// The payload on this channel is <see cref="NatsInvocation"/> objects containing
    ...
    public NatsChannels(string prefix, string serverName)
    {
        _prefix = prefix;
